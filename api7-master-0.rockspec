...
source = {
    url = "https://github.com/api7/api7-ee-3-gateway",
    branch = "master",
}

description = {
    summary = "api7-ee-3-gateway is a cloud-native microservices API gateway, delivering the ultimate performance, security and scalable platform for all your APIs and microservices.",
    homepage = "https://github.com/api7/api7-ee-3-gateway",
...
dependencies = {
    ...
    "lua-resty-healthcheck-api7 = 2.2.5",
    "api7-lua-resty-jwt = 0.2.6",
    "lua-resty-hmac-ffi = 0.05",
    "lua-resty-cookie = 0.1.0",
    "lua-resty-session = 3.10",
    "lua-resty-saml = 0.2.3",
    ...
    "binaryheap = 0.4",
    "api7-dkjson = 0.1.1",
    "lua-resty-redis-cluster = 1.2.0-0",
