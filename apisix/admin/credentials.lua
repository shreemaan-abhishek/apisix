...
-- Only if GET credentials list, credential_id is nil, sub_path is like
-- {consumer_name}/credentials, so return value is /consumers/{consumer_name}/credentials.
-- In the other methods, credential_id is not nil,
-- return value is /consumers/{consumer_name}/credentials/{credential_id}.
