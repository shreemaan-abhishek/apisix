...
key-auth failed to authenticate the request, code: 401. error: Missing API key found in request
...
{"message":"Authorization Failed"}
--- error_log
jwt-auth failed to authenticate the request, code: 401. error: failed to find consumer: Missing related consumer
...
{"message":"Authorization Failed"}
--- error_log
openid-connect failed to authenticate the request, code: 401. error: OIDC introspection failed: No bearer token found in request
