...
--- error_code: 400
--- response_body
{"error_msg":"failed to check the configuration of plugin limit-count-advanced err: value should match only one schema, but matches both schemas 1 and 2"}
...
--- error_code: 400
--- response_body
{"error_msg":"failed to check the configuration of plugin limit-count-advanced err: duplicate key '${http_company}' in rules"}
...
project: kubernetes
--- error_log eval
qr/limit key: route1:[^:]+:kubernetes/
