...
GET /t
--- error_log
use etcd host as sni: admin.apisix.dev



=== TEST 7: configure etcd cli explicit sni
--- yaml_config
apisix:
  ssl:
    ssl_trusted_certificate: t/certs/mtls_ca.crt
...
GET /t
--- no_error_log
use etcd host as sni



=== TEST 8: configure a invalid etcd  host
--- yaml_config
apisix:
  ssl:
    ssl_trusted_certificate: t/certs/mtls_ca.crt
...
use etcd host as sni
--- error_log
failed to start a etcd instance: invalid http host: https://:22379
