...
=== TEST 12: the main watcher should be initialised once
--- yaml_config
apisix:
  node_listen: 1984
deployment:
...
=== TEST 14: the main watcher should be initialised once
--- yaml_config
apisix:
  node_listen: 1984
deployment:
...
=== TEST 15: watch revision should be upgraded when timeout occurs
--- yaml_config
deployment:
  role: traditional
  role_traditional:
