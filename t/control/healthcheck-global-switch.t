...
--- config
    location /t {
        content_by_lua_block {
            ...
            code, body, res = t.test('/v1/healthcheck/upstreams/1',
                ngx.HTTP_GET)
            ngx.status = code
            ngx.print(body)
        }
...
--- response_body
{}
{"error_msg":"no checker for upstreams[1]"}
...
--- config
    location /t {
        content_by_lua_block {
            ...
            code, body, res = t.test('/v1/healthcheck/routes/1',
                ngx.HTTP_GET)
            ngx.status = code
            ngx.print(body)
        }
...
--- response_body
{}
{"error_msg":"no checker for routes[1]"}
...
--- config
    location /t {
        content_by_lua_block {
            ...
            code, body, res = t.test('/v1/healthcheck/services/1',
                ngx.HTTP_GET)
            ngx.status = code
            ngx.print(body)
        }
...
--- response_body
{}
{"error_msg":"no checker for services[1]"}
