...
TEST_NAME="Case 16: Single core: Enable plugin:AI Proxy Multi (2 instances, weighted 1:4; health check enabled; nodes with weight 1 are unhealthy) Prometheus + stream=true"
          ...
          "instances": [
              {
                ...
                "checks": {
                  ...
                  "override": {
                      "endpoint": "http://host.docker.internal:7837/v1/chat/completions/json"
                  }
              },
              {
                  "name": "deepseek",
                ...
                "checks": {
                  ...
                  "override": {
                      "endpoint": "http://host.docker.internal:7737/v1/chat/completions/json"
                  }
              }
...
# POST request to AI Proxy endpoint
wrk -c 200 -t 2 -d 60s -R 5000 -s ./tests/post-test-stream.lua http://127.0.0.1:9080 > wrk.txt &
sleep 30
