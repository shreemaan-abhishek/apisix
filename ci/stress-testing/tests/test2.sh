...
TEST_NAME="Case 2: Single core, Service + upstream, no hit route, torture testing 1 min"
echo "-----------Running test2: $TEST_NAME---------------"
...
wrk -c 200 -t 2  -d 60s  -R 40000    http://127.0.0.1:9080/hello2 >wrk.txt  &
sleep 30
