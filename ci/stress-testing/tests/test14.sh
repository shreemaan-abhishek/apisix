...
TEST_NAME="Case 14: Multi-core: Enable plugin:AI Proxy Multi (2 instances, weighted 1:4) + AI Rate Limiting + Prometheus + stream=true"
          ...
          "instances": [
              {
                  ...
                  "override": {
                      "endpoint": "http://host.docker.internal:7737/v1/chat/completions"
                  }
              },
              {
                  "name": "deepseek",
