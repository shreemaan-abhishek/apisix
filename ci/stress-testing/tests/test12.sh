...
TEST_NAME="Case 12: Single core, Enable plugin: AI Proxy + AI Rate Limiting  + Prometheus + Do not hit route"
...
wrk -c 200 -t 2 -d 60s -R 5000 -s ./tests/post-test-nopath.lua http://127.0.0.1:9080 > wrk.txt &
sleep 30
