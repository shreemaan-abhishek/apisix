...
TEST_NAME="Case 15: Single core: Enable plugin:AI Proxy Multi (2 instances, weighted 1:4; health check enabled; nodes with weight 1 are unhealthy) Prometheus + stream=false"
...
sleep 40
top -b - 1 -p $worker_pid >after_cpu_mem.txt
