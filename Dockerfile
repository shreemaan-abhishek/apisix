...
RUN set -ex; \
    ...
    set -ex; \
    arch=$(dpkg --print-architecture); \
    wget https://github.com/api7/apisix-build-tools/releases/download/api7ee-runtime/1.1.7/api7ee-runtime_1.1.7-0.debianbullseye-slim_${arch}.deb; \
    dpkg -i ./api7ee-runtime_1.1.7-0.debianbullseye-slim_${arch}.deb
